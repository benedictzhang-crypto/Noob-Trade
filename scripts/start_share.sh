...
export MARKET_DATA_PROVIDER="${MARKET_DATA_PROVIDER:-auto}"
export MARKET_DATA_CACHE_TTL_SECONDS="${MARKET_DATA_CACHE_TTL_SECONDS:-90}"
export MARKET_DATA_INTRADAY_CACHE_TTL_SECONDS="${MARKET_DATA_INTRADAY_CACHE_TTL_SECONDS:-20}"
export MARKET_DATA_OVERVIEW_CACHE_TTL_SECONDS="${MARKET_DATA_OVERVIEW_CACHE_TTL_SECONDS:-900}"
export OKX_DATA_BASE_URL="${OKX_DATA_BASE_URL:-https://www.okx.com}"
export COINGECKO_DATA_BASE_URL="${COINGECKO_DATA_BASE_URL:-https://api.coingecko.com/api/v3}"
export CRYPTO_EXCLUDE_STABLECOINS="${CRYPTO_EXCLUDE_STABLECOINS:-true}"
export ENABLE_DEMO_FALLBACK="${ENABLE_DEMO_FALLBACK:-true}"
export ENABLE_DEMO_FALLBACK_ALL_SYMBOLS="${ENABLE_DEMO_FALLBACK_ALL_SYMBOLS:-true}"
export USE_MOCK_FALLBACK="${USE_MOCK_FALLBACK:-true}"
